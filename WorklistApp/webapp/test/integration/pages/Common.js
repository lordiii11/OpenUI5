sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/WorklistApp/app", ".html");
		...
		return Opa5.extend("zjblessons.WorklistApp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/WorklistApp/localService/mockserver"], function (mockserver) {
